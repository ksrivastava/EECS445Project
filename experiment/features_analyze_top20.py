...
# # plt.xlabel('False Positive Rate')
# # plt.ylabel('True Positive Rate')
# # plt.title('Receiver operating characteristic - Top 20 Fisher')
# # plt.legend(loc="lower right")
# # plt.savefig('../features/roc_plots/top_20_fisher_cv')
# # plt.show()
# #
# #
# # #
...
# # plt.xlabel('False Positive Rate')
# # plt.ylabel('True Positive Rate')
# # plt.title('Receiver operating characteristic - Top 20 InfoGain')
# # plt.legend(loc="lower right")
# # plt.savefig('../features/roc_plots/top_20_infoG_cv')
# # plt.show()
# #
# # ################## fsTest
# #
...
# # plt.xlabel('False Positive Rate')
# # plt.ylabel('True Positive Rate')
# # plt.title('Receiver operating characteristic - Top 20 T-test')
# # plt.legend(loc="lower right")
# # plt.savefig('../features/roc_plots/top_20_fsTest_cv')
# # # plt.show()
# #
# # ######### Chi Square
# # #
...
# # plt.xlabel('False Positive Rate')
# # plt.ylabel('True Positive Rate')
# # plt.title('Receiver operating characteristic - Top 20 ChiSquare')
# # plt.legend(loc="lower right")
# # plt.savefig('../features/roc_plots/top_20_fsChiSquare_cv')
# # plt.show()
# #
...
out = open('../features/weight_vectors/top20_weighted_features.txt','wb')
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('Receiver operating characteristic - Top 20 Average')
plt.legend(loc="lower right")
plt.savefig('../features/roc_plots/top_20_weighted_cv')
# plt.show()
